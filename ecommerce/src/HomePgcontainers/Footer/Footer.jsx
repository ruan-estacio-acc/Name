    ...
    return (
        <>  
            ...
            <GlobalSpacer aria-hidden="true"/>
                            ...
                            <FooterWrapper>
                            <div  style={{position: "relative", width: "1440px", height: "100%", backgroundColor: "#1215daff", display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "center", paddingTop: "0"}}>
