...
import { ReviewBackground, ReviewContainer, ReviewWrapper, ReviewHeader, ReviewTitle, ReviewGrid, ReviewViewport, ReviewNav, ReviewNavButton } from './ReviewSection.styles';
...
export const ReviewSection = () => {
    ...
    return (
        <ReviewContainer >
             <ReviewBackground />
            <ReviewWrapper style={{backgroundColor: "black"}}>
                <ReviewHeader>
